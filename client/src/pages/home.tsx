    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-border/50 h-20 flex items-center">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <button className="bg-primary text-white px-6 py-2.5 rounded-full font-bold hover:bg-primary/90 transition-colors text-sm">
            Book Service
          </button>
        </div>
      </nav>
      ...
      <main className="flex-1 pt-20">
        ...
        <div ref={quizRef} className="py-24 bg-secondary/30 relative">
           {/* Decoration */}
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 border-t border-slate-800">
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12">
          <div>
            <div className="text-white font-heading font-bold text-2xl mb-6">ComfortAir</div>
